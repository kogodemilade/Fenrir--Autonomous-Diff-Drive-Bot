...
class SimpleController(Node):
    def __init__(self):
        ...
        self.vel_sub_ = self.create_subscription(TwistStamped, "fenrir_controller/cmd_vel", self.VelCallback, 10)
        ...
        self.odom_pub_ = self.create_publisher(Odometry, "fenrir_controller/odom", 5)
