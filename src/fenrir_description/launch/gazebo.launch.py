...
def generate_launch_description():
    ...
    fenrir_description = get_package_share_directory("fenrir_description")
    fenrir_description_prefix = get_package_prefix("fenrir_description")
    ...
    z_pose = '0.01'
    model_pat = os.path.join(fenrir_description, 'models')
    model_path = model_pat + os.pathsep + os.path.join(fenrir_description_prefix, "share")
    
    xacro_file = os.path.join(fenrir_description, "urdf", "fenrir.urdf.xacro")
    ...
    world = os.path.join(
        get_package_share_directory('fenrir_description'),
        'worlds',
        'warehouse.world.sdf'
    )
    ...
    spawn_robot = Node(
        package="ros_gz_sim",
        executable="create",
        arguments=["-name", "fenrir", "-topic", "robot_description", '-x', x_pose,
